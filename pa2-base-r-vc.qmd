...
punctuation <- c(".", ",", "!", "?", "'", '"', "(", ")", " ", "-", ";", ":")
# copied the correct coding from the practice activity
...
#copied correct code from the practice activity
```
...
# copied code from class activity
```

5.  Create a new variable in your dataframe that assigns a number to each symbol.

```{r}
#| label: new-varaibles-for-dataframe
my_symbols$num <- 1:len
#copied code from activity
```
